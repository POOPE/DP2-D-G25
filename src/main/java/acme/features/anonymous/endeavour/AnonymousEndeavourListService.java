...
@Service
public class AnonymousEndeavourListService implements AbstractListService<Anonymous, Endeavour> {

	// Internal state ---------------------------------------------------------

	@Autowired
	protected AnonymousEndeavourRepository repository;
	...
	public void unbind(final Request<Endeavour> request, final Endeavour entity, final Model model) {
		...
		request.unbind(entity, model, "executionStart","executionEnd","duration");
	}
